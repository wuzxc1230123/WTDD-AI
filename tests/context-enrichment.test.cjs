/**
 * WTDD Tools Tests - Adaptive Context Enrichment for 1M Models
 *
...
describe('execute-phase.md context enrichment', () => {
  const EXECUTE_WORKFLOW_PATH = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'execute-phase.md');
...
describe('plan-phase.md context enrichment', () => {
  const PLAN_WORKFLOW_PATH = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'plan-phase.md');
