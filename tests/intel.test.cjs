/**
 * Tests for what-the-dog-doing/bin/lib/intel.cjs
 *
 * Covers: query, status, diff, validate, snapshot, patch-meta,
 * extract-exports, enabled/disabled gating, and CLI routing via wtdd-tools.
 */
...
const {
  ...
  isIntelEnabled,
  INTEL_FILES,
} = require('../what-the-dog-doing/bin/lib/intel.cjs');
...
// ─── CLI routing via wtdd-tools ──────────────────────────────────────────────

describe('wtdd-tools intel subcommands', () => {
  let tmpDir;
