 ...
 *
 * When users set commit_docs: false during /wtdd-new-project, .planning/
 * files should never be staged or committed. The wtdd-tools.cjs commit
...
const EXECUTE_PHASE_PATH = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'execute-phase.md');
