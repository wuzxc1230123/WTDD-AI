...
const REFERENCE_PATH = path.join(__dirname, '..', 'what-the-dog-doing', 'references', 'planning-config.md');
const CORE_PATH = path.join(__dirname, '..', 'what-the-dog-doing', 'bin', 'lib', 'core.cjs');
