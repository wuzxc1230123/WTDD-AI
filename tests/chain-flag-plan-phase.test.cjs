/**
 * WTDD Tools Tests - chain flag preservation in plan-phase
 *
...
describe('plan-phase chain flag preservation (#1620)', () => {
  const planPath = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'plan-phase.md');
  const discussPath = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'discuss-phase.md');
