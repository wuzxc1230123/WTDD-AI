 ...
 *
 * Verifies that the wtdd-verifier agent filters gaps addressed in later
...
describe('verifier deferred-items filtering (#1624)', () => {
  ...
  describe('agents/wtdd-verifier.md', () => {
    ...
    test('contains Step 9b for filtering deferred items', () => {
      ...
      assert.ok(
        ...
        'wtdd-verifier.md should contain Step 9b or "Filter Deferred" section'
      );
    });
  ...
  describe('what-the-dog-doing/workflows/verify-phase.md', () => {
    const workflowPath = path.join(ROOT, 'what-the-dog-doing', 'workflows', 'verify-phase.md');
    let workflowContent;
  ...
  describe('what-the-dog-doing/references/planner-gap-closure.md', () => {
    const closurePath = path.join(ROOT, 'what-the-dog-doing', 'references', 'planner-gap-closure.md');
    let closureContent;
