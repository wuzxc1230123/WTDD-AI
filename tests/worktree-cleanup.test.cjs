/**
 * WTDD Tools Tests - worktree cleanup after executor completes
 *
...
describe('worktree cleanup after executor completes (#1496)', () => {
  const executePhasePath = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'execute-phase.md');
  const quickPath = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'quick.md');
