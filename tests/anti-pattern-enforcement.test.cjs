...
const PAUSE_WORK = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'pause-work.md');
const DISCUSS_PHASE = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'discuss-phase.md');
const EXECUTE_PHASE = path.join(__dirname, '..', 'what-the-dog-doing', 'workflows', 'execute-phase.md');
