...
const SH_HOOKS = [
  { name: 'wtdd-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'wtdd-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'wtdd-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];
