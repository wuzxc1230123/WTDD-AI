#!/bin/bash
# wtdd-validate-commit.sh — PreToolUse hook: enforce Conventional Commits format
...
# Uses Node.js for JSON parsing (always available in WTDD projects, no jq dependency).
#
