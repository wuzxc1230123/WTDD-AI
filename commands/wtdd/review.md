...
planning via /wtdd-plan-phase --reviews.

**Flow:** Detect CLIs → Build review prompt → Invoke each CLI → Collect responses → Write REVIEWS.md
</objective>

<execution_context>
@~/.claude/what-the-dog-doing/workflows/review.md
</execution_context>
...
<process>
Execute the review workflow from @~/.claude/what-the-dog-doing/workflows/review.md end-to-end.
</process>
