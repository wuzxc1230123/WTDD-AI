...
type: prompt
name: wtdd:forensics
description: Post-mortem investigation for failed WTDD workflows — analyzes git history, artifacts, and state to diagnose what went wrong
...
<objective>
Investigate what went wrong during a WTDD workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/what-the-dog-doing/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @~/.claude/what-the-dog-doing/workflows/forensics.md end-to-end.
</process>
