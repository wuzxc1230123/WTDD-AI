...
<execution_context>
@~/.claude/what-the-dog-doing/workflows/autonomous.md
...
Project context, phase list, and state are resolved inside the workflow using init commands (`wtdd-tools.cjs init milestone-op`, `wtdd-tools.cjs roadmap analyze`). No upfront context loading needed.
</context>

<process>
Execute the autonomous workflow from @~/.claude/what-the-dog-doing/workflows/autonomous.md end-to-end.
