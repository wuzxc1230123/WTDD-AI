...
<execution_context>
@~/.claude/what-the-dog-doing/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/what-the-dog-doing/workflows/session-report.md end-to-end.
</process>
