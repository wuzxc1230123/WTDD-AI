...
---
<objective>
Auto-fix issues found by code review. Reads REVIEW.md from the specified phase, spawns wtdd-code-fixer agent to apply fixes, and produces REVIEW-FIX.md summary.
...
<execution_context>
@~/.claude/what-the-dog-doing/workflows/code-review-fix.md
</execution_context>
...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `wtdd-tools init phase-op` and delegated to agent via config blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review-fix workflow from @~/.claude/what-the-dog-doing/workflows/code-review-fix.md end-to-end.
...
- Agent spawning (wtdd-code-fixer)
