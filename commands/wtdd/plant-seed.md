...
Consumed by: /wtdd-new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/what-the-dog-doing/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/what-the-dog-doing/workflows/plant-seed.md end-to-end.
</process>
