...
|----------|---------------|---------------|-------|
| plan-phase | wtdd-planner | wtdd-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | wtdd-executor | wtdd-verifier | Post-execution verification |
| discuss-phase | orchestrator | wtdd-plan-checker | Inline revision by orchestrator |
