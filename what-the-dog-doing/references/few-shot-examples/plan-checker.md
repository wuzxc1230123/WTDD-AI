...
**Input:** Two plans in wave 1 -- Plan 01 modifies `what-the-dog-doing/workflows/execute-phase.md`, Plan 02 also modifies `what-the-dog-doing/workflows/execute-phase.md`. No `depends_on` declared.
...
>     severity: BLOCKER
>     finding: "Plans 01 and 02 both modify what-the-dog-doing/workflows/execute-phase.md in wave 1 with no depends_on relationship. Concurrent execution will cause merge conflicts or lost changes."
