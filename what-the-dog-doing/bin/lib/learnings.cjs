 ...
 *
 * Provides a cross-project learnings store at ~/.wtdd/knowledge/.
...
const DEFAULT_STORE_DIR = path.join(os.homedir(), '.wtdd', 'knowledge');
...
/**
 * Handle `wtdd-tools learnings list`
...
/**
 * Handle `wtdd-tools learnings query --tag <tag>`
 * @param {string} tag
 * @param {boolean} raw - Raw output flag
 */
...
/**
 * Handle `wtdd-tools learnings copy`
...
/**
 * Handle `wtdd-tools learnings prune --older-than <duration>`
...
/**
 * Handle `wtdd-tools learnings delete <id>`
 * @param {string} id
 * @param {boolean} raw - Raw output flag
 */
