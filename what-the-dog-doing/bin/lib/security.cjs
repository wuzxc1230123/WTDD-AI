 ...
 *
 * This module centralizes security checks for WTDD tooling. Because WTDD generates
...
const INJECTION_PATTERNS = [
  ...
  // Note: <instructions> is excluded — WTDD uses it as legitimate prompt structure
