...
│   └── wtdd/           # WTDD-specific commands
├── what-the-dog-doing/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/wtdd/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `what-the-dog-doing/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `what-the-dog-doing/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/what-the-dog-doing/workflows/{name}.md`

**New Reference Document:**
- Implementation: `what-the-dog-doing/references/{name}.md`
