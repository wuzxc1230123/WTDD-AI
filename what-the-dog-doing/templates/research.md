...
**CRITICAL:** If CONTEXT.md exists from /wtdd-discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches WTDD templates)
