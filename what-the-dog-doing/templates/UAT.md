...
- This section feeds directly into /wtdd-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /wtdd-plan-phase --gaps with root causes
...
**Creation:** When /wtdd-verify-work starts new session
...
- `/wtdd-verify-work {phase}` picks up from first pending/blocked test
