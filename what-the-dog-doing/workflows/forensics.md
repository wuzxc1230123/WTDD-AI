...
Post-mortem investigation for failed or stuck WTDD workflows. Analyzes git history,
...
3. {Recovery command if applicable — e.g., `/wtdd-resume-work`, `/wtdd-execute-phase N`}

---

*Report generated by `/wtdd-forensics`. All paths redacted for portability.*
```
