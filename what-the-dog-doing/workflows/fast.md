...
Use /wtdd-quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /wtdd-quick instead:
  /wtdd-quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /wtdd-quick
- If you're unsure how to implement it, STOP and redirect to /wtdd-quick
</guardrails>
