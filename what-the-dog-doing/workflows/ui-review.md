<purpose>
Retroactive 6-pillar visual audit of implemented frontend code. Standalone command that works on any project — WTDD-managed or not. Produces scored UI-REVIEW.md with actionable findings.
</purpose>
...
AGENT_SKILLS_UI_REVIEWER=$(node "$HOME/.claude/what-the-dog-doing/bin/wtdd-tools.cjs" agent-skills wtdd-ui-reviewer 2>/dev/null)
```

Parse: `phase_dir`, `phase_number`, `phase_name`, `phase_slug`, `padded_phase`, `commit_docs`.

```bash
UI_AUDITOR_MODEL=$(node "$HOME/.claude/what-the-dog-doing/bin/wtdd-tools.cjs" resolve-model wtdd-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 WTDD ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /wtdd-execute-phase {N} first."
...
```markdown
Read ~/.claude/agents/wtdd-ui-auditor.md for instructions.
...
- `/wtdd-verify-work {N}` — UAT testing
- `/wtdd-plan-phase {N+1}` — plan next phase
...
```bash
node "$HOME/.claude/what-the-dog-doing/bin/wtdd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] wtdd-ui-auditor spawned with correct context
