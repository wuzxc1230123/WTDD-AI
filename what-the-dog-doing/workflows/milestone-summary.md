...
4. If nothing found: error "No milestone found. Run /wtdd-new-project or /wtdd-new-milestone first."
...
```bash
wtdd-tools.cjs commit "docs(v${VERSION}): generate milestone summary for onboarding" \
...
If the user is done:
- Suggest next steps: `/wtdd-new-milestone`, `/wtdd-progress`, or sharing the summary with the team

## Step 9: Update STATE.md

```bash
wtdd-tools.cjs state record-session \
