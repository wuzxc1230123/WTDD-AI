...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /wtdd-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/what-the-dog-doing/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/what-the-dog-doing/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/what-the-dog-doing/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/what-the-dog-doing/templates/discovery.md
...
Use ~/.claude/what-the-dog-doing/templates/discovery.md.
...
1. Discuss phase context (/wtdd-discuss-phase [current-phase])
2. Create phase plan (/wtdd-plan-phase [current-phase])
