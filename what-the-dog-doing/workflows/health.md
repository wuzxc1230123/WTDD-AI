...
```bash
node "$HOME/.claude/what-the-dog-doing/bin/wtdd-tools.cjs" validate health $REPAIR_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /wtdd-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /wtdd-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /wtdd-health --repair
```
</step>
...
```
Would you like to run /wtdd-health --repair to fix N issues automatically?
```
...
```bash
node "$HOME/.claude/what-the-dog-doing/bin/wtdd-tools.cjs" validate health
```
