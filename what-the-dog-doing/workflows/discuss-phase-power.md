...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/wtdd-discuss-phase`.
...
Consider running /wtdd-discuss-phase {N} again to refine before planning.
```
