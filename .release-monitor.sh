#!/usr/bin/env bash
# Release monitor for wtdd-build/what-the-dog-doing
# Checks every 15 minutes, writes new release info to a signal file

REPO="wtdd-build/what-the-dog-doing"
SIGNAL_FILE="/tmp/wtdd-new-release.json"
STATE_FILE="/tmp/wtdd-monitor-last-tag"
LOG_FILE="/tmp/wtdd-monitor.log"
